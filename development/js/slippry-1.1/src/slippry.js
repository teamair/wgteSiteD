...
(function ($) {
  ...
  defaults = {
    ...
    captionsEl: '.highlight_body_text', // $ selector for captions wrapper
  ...
  $.fn.slippry = function (options) {
    var slip, el, prepareFiller, getFillerProportions, init, updateCaptionTitle, updateCaption, initPager, initControls, ready, transitionDone, whichTransitionEvent,
	...
	updateCaptionTitle = function () {
		...
		captionTitle = $('img', slip.vars.active).attr('title');
		$(".highlight_headline").html(captionTitle).show();
	};
    ...
    updateCaption = function () {
      ...
      if (slip.settings.captions !== false) {
        ...
        if (slip.settings.captions !== 'custom') {
          ...
          wrapper = $(slip.settings.captionsEl); //wrapper for caption
          
        }
        if ((caption !== undefined) && (caption !== '')) {
          wrapper.html(caption).show(); //wrapper with caption inside it 
        } else {
          wrapper.hide();
        }
      }
